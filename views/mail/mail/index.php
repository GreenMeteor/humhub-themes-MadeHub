		...
		<div class="col-sm-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<?= Html::a(Yii::t('MailModule.views_mail_index', 'New message'), ['/mail/mail/create'], array('class' => 'btn btn-info pull-right', 'data-target' => '#globalModal')); ?>
				</div>
				...
				<ul id="inbox" class="media-list">
					<?php if (count($userMessages) != 0) : ?>
						<?php foreach ($userMessages as $userMessage) : ?>
							<?= $this->render('_messagePreview', array('userMessage' => $userMessage)); ?>
						<?php endforeach; ?>
					<?php else {
    : ?>
						<li class="placeholder"><?= Yii::t('MailModule.views_mail_index', 'There are no messages yet.');
}
?></li>
					<?php endif; ?>
				</ul>
