<?php if ($clickable): ?><a href="<?php echo \yii\helpers\Url::to(['/activity/link', 'id' => $record->id])?>"><?php endif; ?>
    <li class="activity-entry" data-stream-entry data-action-component="activity.ActivityStreamEntry" data-content-key="<php echo $record->content->id ?>">
        <div class="media">
