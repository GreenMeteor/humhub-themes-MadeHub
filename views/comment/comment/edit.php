...
<div class="content_edit input-container" id="comment_edit_<?= $comment->id; ?>">
    ...
    <div class="comment-buttons">
        ...
        <a href="#" class="btn btn-default btn-sm btn-comment-submit" 
            ...
            data-action-url="<?php echo Url::to(['/comment/comment/edit', 'id' => $comment->id, 'contentModel' => $comment->object_model, 'contentId' => $comment->object_id]) ?>"
            data-action-submit
            data-ui-loader>
             <?php echo Yii::t('CommentModule.views_edit', 'Save') ?>
        </a>
