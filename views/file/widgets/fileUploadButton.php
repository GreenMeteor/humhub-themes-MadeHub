...
<?= Html::hiddenInput($this->context->fileListFieldName, '', array('id' => "fileUploaderHiddenField_" . $uploaderId)); ?>
...
<span class="btn btn-info fileinput-button tt" data-toggle="tooltip" data-placement="bottom" title=""
    ...
    <input id="fileUploaderButton_<?= $uploaderId; ?>" type="file" name="files[]"
           data-url="<?= Url::to(['/file/file/upload', 'objectModel' => $objectModel, 'objectId' => $objectId]); ?>" multiple>
</span>

<script>
    $(function () {
        'use strict';
        installUploader("<?= $uploaderId; ?>");
