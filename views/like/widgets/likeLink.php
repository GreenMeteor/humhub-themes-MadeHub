...
<span class="likeLinkContainer" id="likeLinkContainer_<?php echo $id ?>">
    ...
    <?php if (count($likes) > 0) { ?>
        ...
        <a href="<?php echo $userListUrl; ?>" data-target="#globalModal">
            <span class="likeCount tt" data-placement="top" data-toggle="tooltip" title="<?php echo $title ?>">(<?php echo count($likes) ?>)</span>
        </a>
    <?php } else { ?>
